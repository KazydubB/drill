...
public class TrueMapWriterImpl extends RepeatedMapWriter implements BaseWriter.TrueMapWriter {

  final TrueMapVector container;
  private boolean rowStarted;

  public TrueMapWriterImpl(TrueMapVector container, FieldWriter parent, boolean unionEnabled) {
    super(container, parent, unionEnabled);
    this.container = container;
  }

  public TrueMapWriterImpl(TrueMapVector container, FieldWriter parent) {
