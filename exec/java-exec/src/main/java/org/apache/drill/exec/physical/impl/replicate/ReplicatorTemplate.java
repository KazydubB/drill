...
//
//public abstract class ReplicatorTemplate implements Replicator {
//  private static final Logger logger = LoggerFactory.getLogger(ReplicatorTemplate.class);
//
...
//                                  final Replicator.Monitor monitor) {
//    switch (svMode) {
//      case FOUR_BYTE:
...
//      case FOUR_BYTE:
//      case TWO_BYTE:
//        throw new UnsupportedOperationException("Replicate does not support selection vector inputs.");
//    }
