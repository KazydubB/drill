...
public class TestPartitionPruning extends PlanTestBase {
  ...
  public void testPartitionPruningWithMetadataCache() throws Exception {
    ...
    int expectedRowCount = 15;
    int actualRowCount = testSql(query);
    assertEquals(expectedRowCount, actualRowCount);

    String usedMetaPattern = "Values\\(tuples=";
    PlanTestBase.testPlanMatchingPatterns(query, new String[]{usedMetaPattern}, null);
  }

  @Test
  public void testPartitionPruningIsNotApplied() throws Exception {
    String[] tableNames = {"multilevel/parquet", "multilevel/json", "multilevel/csv"};
    String[] queries = {
